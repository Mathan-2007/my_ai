...
<p>All API services accept an optional <code>options</code> argument (usually the last one and of type <a href="https://github.com/pocketbase/js-sdk/blob/master/src/services/utils/options.ts"><code>SendOptions</code></a>), that can be used to provide:</p>
<ul>
